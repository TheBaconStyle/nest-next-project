...
import {FindMany, FindOne, OneOrMany, PartialFields, RequiredFields,} from 'src/shared/types/database.type'
...
export class CategoriesService {
  ...
  async findOne(findData: FindOne<Category>) {
    return await this.categoriesRepo.findOneOrFail({where: findData})
  }
